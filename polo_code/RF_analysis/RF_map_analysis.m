...
cell_no=28;
basedir='/Freiwald/ppolosecki/lspace/quincy/';
proc_dir=fullfile(basedir,cell_str(cell_no).dir,'proc');
mat_logfile=cell_str(cell_no).RF.mat{end};
hdf_file= cell_str(cell_no).RF.hdf{end};
...
cluster_used=cell_str(cell_no).unit;% Select the unit you want, unless you select use_mode_unit
use_mode_unit=false;
xx=0;%25;
